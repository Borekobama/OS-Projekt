...
public class Communicator {
    ...
    // Trennung von Ring und Star Logik wichtig.
    ...
    /**
     * Generic send single value operation, non-blocking.
     * @param <T> the type to send
     * @param value the value to send
     * @param dest the destination process rank
     * @param serializer handles type conversion
     */
    public <T> void send(T value, int dest, Serializers.Serializer<T> serializer) throws IOException {
        serializer.send(value, getOutputStream(dest));
    }
...
// Convenience-Methoden für einzelne primitive Werte

    /**
     * Send single integer
     */
    public void send(int value, int dest) throws IOException {
        send(value, dest, Serializers.INTEGER);
    }
...
// Convenience-Methoden für einzelne Werte
    ...
    /**
     * Generic reduce operation, blocking for root, non-blocking for all others.
...
// Convenience-Methoden für häufige Typen
    ...
    // Schlecht generisch zu machen bei Array von primitiven Datentypen.
